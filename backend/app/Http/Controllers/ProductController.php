...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'language' => 'nullable|in:العربية,English,كلاهما,ar,en',
        ...
        elseif ($language === 'en') $language = 'English';
        ...
        $product = Product::create([
            ...
            'final_description' => $request->input('final_description') ?? $request->input('description'),
